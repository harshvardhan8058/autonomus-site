...
_SYSTEM_PROMPT = (
    ...
    "- Do NOT add an 'Executive Summary' step: the service synthesizes a "
    "genuine executive summary from the finished content automatically and "
    "places it first, so a planner-authored one would be redundant.\n"
